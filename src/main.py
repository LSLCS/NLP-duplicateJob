...
# print("\nSimilarity calculated, df_similarity", df_similarity.head(3))

# save csv
# df_similarity.to_csv("largeFile/similarity.csv", index=False)

# print(df['jobDescRaw'][df_similarity['job_id_1'][0]])
# print("========")
# print(df['jobDescRaw'][df_similarity['job_id_2'][0]])


# pltdf = df_similarity['similarity_score'][:3000]
...
# # sns.kdeplot(pltdf, fill=True)
# sns.kdeplot(df_similarity['similarity_score'], fill=True)
...
# df_duplicates = pd.merge(df_duplicates_merged, df[['jobTitle', 'companyName']], left_on='job_id_2', right_index=True, suffixes=('_1', '_2'))
